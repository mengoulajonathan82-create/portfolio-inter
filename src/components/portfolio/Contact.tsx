  ...
  return <section id="contact" className="py-32">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-5 gap-12">
          ...
          duration: 0.6,
          delay: 0.3
        }} onSubmit={handleSubmit} className="md:col-span-3 space-y-6">
            ...
            <button type="submit" className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-primary-foreground rounded-full font-medium hover:bg-primary/90 transition-colors duration-200">
              Envoyer
              <Send size={18} />
            </button>
          </motion.form>
